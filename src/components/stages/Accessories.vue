...
import Icon17 from '@/components/icons/Icon17.vue'
      ...
      <div class="col stage__panel">
        <div class="stage__panel-inner">
          ...
          <div class="stage__information">
            ...
            <h2 class="stage__title title title_color_grey"><strong>Steckdosen.</strong> Setzen.</h2>
          </div>
          ...
          <div class="card-checkbox" :class="{'card-checkbox_active': accessoriesOn}">
            <div class="card-checkbox__content">
              ...
              <div class="inline-flex items-center">
                <div class="card-checkbox__turn-button turn-button" :data-turn="accessoriesOn" @click="toggleAccessories">
                  <span class="card-checkbox__turn-circle"></span>
                </div>
                <span class="card-checkbox__socket-price">ab 30€</span>
              </div>
            </div>
            <img src="//rueckwand24.com/cdn/shop/t/332/assets/socket.svg?v=163782654609713192881697114467"
                class="card-checkbox__image">
          </div>

          <div class="stage__videos videos" :style="{'display': accessoriesOn ? 'block' : 'none'}">
            <div id="video_id_stage-3-1" class="video undefined realtive" data-html2canvas-ignore="true">
              <a class="video__preview video__play-trigger" data-te-toggle="modal"
                  data-te-target="#modalNewCropperSteckdosen">
                <img src="//rueckwand24.com/cdn/shop/t/332/assets/preview-video-3.jpg?v=87694546714977689501697114473"
              ...
              <div class="video__content">
                <span class="video__title"><strong>Steckdosen Ausschnitte</strong> wie finde ich die richtigen Maße?</span>
              </div>
          ...
          <div class="accessories__list-place" :style="{'display': accessoriesOn ? 'block' : 'none'}">
          ...
          <div class="accessories__button-place" :style="{'display': accessoriesOn ? 'block' : 'none'}">
            <span
              class="button button_width_auto button_color_green button_border-1_green accessory-add customizer__button accessories__add-button">Steckdose
              hinzufügen +</span>
          </div>
        </div>
      </div>
