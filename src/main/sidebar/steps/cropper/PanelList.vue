...
import Icon16 from '@/ui/icons/Icon16.vue'
import PanelListItem from './PanelListItem.vue'
...
export default {
  ...
  methods: {
    ...mapActions(useMainStore, ['addPanel', 'removePanel', 'activatePanel']),
    createPanel() {
      this.addPanel({ w: 30, h: 40 })
    },
    deletePanel(id) {
...
<template>
  <div class="cropper__customizer customizer">
    ...
    <span
      class="button button_width_auto button_color_green button_border-1_green panel-add customizer__button"
      @click="createPanel"
      >Rückwand hinzufügen<span class="customizer__button-icon">+</span>
